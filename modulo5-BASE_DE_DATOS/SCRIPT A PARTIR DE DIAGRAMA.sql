...
CREATE TABLE IF NOT EXISTS `mydb`.`salaries` (
  ...
  INDEX `fk_salario_Empleado1_idx` (`emp_no` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`titles` (
  ...
  `Emp_no` INT NOT NULL,
  PRIMARY KEY (`from_date`, `Emp_no`),
  INDEX `fk_titulos_Empleado1_idx` (`Emp_no` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`dept_manager` (
  ...
  INDEX `fk_Departamento_has_Empleado_Empleado1_idx` (`Emp_no` ASC),
  INDEX `fk_Departamento_has_Empleado_Departamento1_idx` (`dept_no` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`dept_emp` (
  ...
  INDEX `fk_Empleado_has_Departamento_Departamento1_idx` (`dept_no` ASC),
  INDEX `fk_Empleado_has_Departamento_Empleado1_idx` (`emp_no` ASC),
